...
export const verifyRegisterOtp = (data) => axios.post(`${API_URL}/verify-register-otp`, data);
export const loginUser = (email, password) => axios.post(`${API_URL}/login`, { email, password });
export const verifyLoginOtp = (data) => axios.post(`${API_URL}/verify-login-otp`, data);
